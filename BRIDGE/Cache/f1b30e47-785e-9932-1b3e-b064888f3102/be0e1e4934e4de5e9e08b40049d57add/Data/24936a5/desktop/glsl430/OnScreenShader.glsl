...
{
l9_51=clamp(l9_0.w*2.0,0.0,1.0);
}
#else
{
float l9_52;
...
{
l9_52=clamp(dot(l9_0.xyz,vec3(l9_0.w)),0.0,1.0);
}
#else
{
float l9_53;
...
{
l9_54=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_0.w;
}
#else
{
float l9_55;
...
{
l9_55=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_0.w;
}
#else
{
float l9_56;
...
{
l9_56=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_57;
#if (sc_BlendMode_Add)
{
l9_57=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_58=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_59;
...
{
l9_59=dot(l9_0.xyz,vec3(0.33333001))*l9_0.w;
}
#else
{
float l9_60;
#if (sc_BlendMode_Min)
{
l9_60=1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
#if (sc_BlendMode_Max)
{
l9_61=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_61=1.0;
...
#endif
l9_49=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_0.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_50);
}
#else
{
vec4 l9_62;
...
{
l9_66=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_65,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_66=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_65,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_64=l9_66;
}
#endif
vec3 l9_67=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_Voxelization)
{
l9_69=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_70;
#if (sc_OutputBounds)
{
float l9_71=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_70=vec4(l9_71,1.0-l9_71,1.0,1.0);
}
#else
{
vec4 l9_72;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_72=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_73;
...
#endif
l9_73=vec4(l9_0.xyz*l9_74,l9_74);
}
#else
{
l9_73=l9_0;
...
vec4 l9_77=sc_OutputMotionVectorIfNeeded(max(l9_75,vec4(0.0)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_93=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
