...
//sampler sampler opacityTexSmpSC 0:18
//sampler sampler sc_OITCommonSampler 0:21
//sampler sampler sc_ScreenTextureSmpSC 0:23
//sampler sampler screenTextureSmpSC 0:26
//texture texture2D intensityTexture 0:0:0:17
//texture texture2D opacityTex 0:1:0:18
//texture texture2D sc_OITAlpha0 0:4:0:21
//texture texture2D sc_OITAlpha1 0:5:0:21
//texture texture2D sc_OITDepthHigh0 0:6:0:21
//texture texture2D sc_OITDepthHigh1 0:7:0:21
//texture texture2D sc_OITDepthLow0 0:8:0:21
//texture texture2D sc_OITDepthLow1 0:9:0:21
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:10:0:21
//texture texture2D sc_OITFrontDepthTexture 0:11:0:21
//texture texture2D sc_ScreenTexture 0:13:0:23
//texture texture2D screenTexture 0:16:0:26
//texture texture2DArray intensityTextureArrSC 0:27:0:17
//texture texture2DArray opacityTexArrSC 0:28:0:18
//texture texture2DArray sc_ScreenTextureArrSC 0:31:0:23
//texture texture2DArray screenTextureArrSC 0:32:0:26
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTexture 85 -1
//spec_const int intensityTextureLayout 86 0
//spec_const int opacityTexLayout 87 0
...
//spec_const int screenTextureLayout 96 0
//SG_REFLECTION_END
...
uniform float opacityblurFactor;
...
vec4 N12_Texture_sample(vec2 coords)
{
vec4 l9_0;
#if (screenTextureLayout==2)
{
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_2=coords.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_3=l9_2;
float l9_4=coords.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_23=texture(screenTextureArrSC,l9_22,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_24=mix(screenTextureBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#else
{
bool l9_25=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_26=coords.x;
sc_SoftwareWrapEarly(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_27=l9_26;
float l9_28=coords.y;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_29=l9_28;
vec2 l9_30;
float l9_31;
#if (SC_USE_UV_MIN_MAX_screenTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_33=l9_27;
float l9_34=1.0;
sc_ClampUV(l9_33,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_32,l9_34);
float l9_35=l9_33;
float l9_36=l9_34;
bool l9_37;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_38=l9_29;
float l9_39=l9_36;
sc_ClampUV(l9_38,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_37,l9_39);
l9_31=l9_39;
...
#endif
vec2 l9_40=sc_TransformUV(l9_30,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_25,l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_25,l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_47=texture(screenTexture,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_48=mix(screenTextureBorderColor,l9_47,vec4(l9_45));
}
#else
{
l9_48=l9_47;
...
vec4 N34_Texture_sample(vec2 coords)
{
vec4 l9_0;
...
vec4 l9_26=texture(screenTextureArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_screenTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
...
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_50=texture(screenTexture,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_51=mix(screenTextureBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
float l9_61=float(l9_53);
float l9_62=exp((-((l9_60*l9_60)+(l9_61*l9_61)))/18.0);
l9_58+=l9_62;
l9_57+=(N12_Texture_sample(l9_1+(vec2(l9_60,l9_61)*(screenTextureSize.zw*blurFactor)))*l9_62);
l9_59++;
continue;
}
else
...
l9_52=l9_54/vec4(l9_55);
}
vec4 l9_63;
if (opacityblurFactor<=0.0)
{
l9_63=N34_Texture_sample(l9_1);
}
else
{
int l9_64;
...
if (l9_70<=6)
{
float l9_71=float(l9_70);
float l9_72=float(l9_64);
float l9_73=exp((-((l9_71*l9_71)+(l9_72*l9_72)))/18.0);
l9_69+=l9_73;
l9_68+=(N34_Texture_sample(l9_1+(vec2(l9_71,l9_72)*(opacityTexSize.zw*opacityblurFactor)))*l9_73);
l9_70++;
continue;
}
else
...
l9_63=l9_65/vec4(l9_66);
}
l9_2=mix(l9_3,l9_52,vec4(l9_63.x));
}
#else
{
vec4 l9_74;
...
if (l9_81<=6)
{
float l9_82=float(l9_81);
float l9_83=float(l9_75);
float l9_84=exp((-((l9_82*l9_82)+(l9_83*l9_83)))/18.0);
l9_80+=l9_84;
l9_79+=(N12_Texture_sample(l9_1+(vec2(l9_82,l9_83)*(screenTextureSize.zw*blurFactor)))*l9_84);
l9_81++;
continue;
}
else
...
l9_74=l9_76/vec4(l9_77);
}
l9_2=l9_74;
}
#endif
vec4 l9_85=l9_2*vec4(Intensity);
float l9_86=l9_85.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_86<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_86<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_90=clamp(dot(l9_85.xyz,vec3(l9_86)),0.0,1.0);
}
#else
{
float l9_91;
...
{
l9_92=(1.0-dot(l9_85.xyz,vec3(0.33333001)))*l9_86;
}
#else
{
float l9_93;
...
{
l9_93=(1.0-clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0))*l9_86;
}
#else
{
float l9_94;
...
{
l9_94=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0)*l9_86;
}
#else
{
float l9_95;
#if (sc_BlendMode_Add)
{
l9_95=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_96;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_96=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0)*l9_86;
}
#else
{
float l9_97;
...
{
l9_97=dot(l9_85.xyz,vec3(0.33333001))*l9_86;
}
#else
{
float l9_98;
#if (sc_BlendMode_Min)
{
l9_98=1.0-clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_99;
#if (sc_BlendMode_Max)
{
l9_99=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_99=1.0;
...
#endif
l9_87=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_85.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_88);
}
#else
{
vec4 l9_100;
...
#endif
vec3 l9_105=mix(l9_102.xyz,definedBlend(l9_102.xyz,l9_85.xyz).xyz,vec3(l9_86));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_110=vec4(mix(vec3(1.0),l9_85.xyz,vec3(l9_86)),l9_86);
}
#else
{
vec4 l9_111;
...
#endif
l9_111=vec4(l9_85.xyz*l9_112,l9_112);
}
#else
{
l9_111=l9_85;
...
#if (sc_OITCompositingPass)
{
vec2 l9_131=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
